                                        ...
                                        <tr key={index}>
                                            <td className="flex items-center px-4 py-4 text-sm text-gray-800">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="#" className="text-blue-500 text-sm">{item.name}</a>
                                                </div>
                                            </td>
                        ...
                        <tr>
                            ...
                            <td className="text-sm text-gray-800">
                                <ul className='bg-white text-center'>
                                    ...
                                    <li className='py-1'>
                                        ₹ {(
                                            (cartItems?.gst?.cgst?.Amt ? Number(cartItems.gst.cgst.Amt) : 0) +
                                            (cartItems?.gst?.sgst?.Amt ? Number(cartItems.gst.sgst.Amt) : 0)
                                        ) || "N/A"}
                                    </li>
                                </ul>
                            </td>
